...
#endif
	return GetVerbPresentProgressive(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
...
#endif
	return GetVerbPresentSimple(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
...
#endif
	return GetVerbPastSimple(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
...
#endif
	return GetVerbPastProgressive(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
...
#endif
	return GetVerbPastPerfect(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
...
#endif
	return GetVerbPastPerfectProgressive(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
...
#endif
	return GetVerbFutureSimple(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
...
#endif
	return GetVerbFutureProgressive(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
...
#endif
	return GetVerbFuturePast(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
...
#endif
	return GetVerbFuturePastProgressive(VerbForm,1) + " " + GetVerbPastSimple(0,VerbNum,true,true);
}
