...
PARSERFILES="Parser.cpp ParserIO.cpp ParseException.cpp ParseElement.cpp ParseGroup.cpp ParseList.cpp ParseDef.cpp ParseNounGroup.cpp ParseBasicVerb.cpp ParseObject.cpp ParseSubject.cpp ParseObjList.cpp ParseNoun.cpp ParseAdjective.cpp ParseIt.cpp ParseExtVerb.cpp ParseSentenceType.cpp ParseTest.cpp "
