...
PARSERFILES="Parser.cpp ParserIO.cpp ParseException.cpp ParseElement.cpp ParseGroup.cpp ParseList.cpp ParseDef.cpp  ParseBasicVerb.cpp ParseSubject.cpp ParseNoun.cpp ParseExtVerb.cpp ParseSentenceType.cpp ParseTest.cpp "
